        ...
        try:
            ...
            if is_show_all:
                ...
                try:
                    ...
                    search_terms = user_query  # Fallback to original query
                products = await self.product_service.search_products(search_terms, limit=10)
            ...
            print(f"ProductFinderAgent error: {e}")
            return "I encountered an error while searching for products. Please try again with a different search term."
